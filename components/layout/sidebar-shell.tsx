  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center justify-between border-b border-sidebar-border px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="flex size-12 items-center justify-center rounded-2xl bg-white/10 text-sidebar-foreground">
        ...
        {mobile ? (
          <button
            type="button"
            className="rounded-full p-2 text-sidebar-foreground/80 hover:bg-white/10"
            onClick={onNavigate}
          >
            <X className="size-4" />
          </button>
